...
export class UsersResolver {
    ...
    @Query(() => UsersModelGQL)
    async getUserById(@Args('_id', { type: () => String }) _id: Schema.Types.ObjectId) {
    ...
    @Roles('Management', 'Project Manager')
    @Mutation(() => UsersModelGQL)
    async deleteUser(@Args('_id', { type: () => String }) _id: Schema.Types.ObjectId) {
    ...
    @Roles('Management', 'Project Manager')
    @Mutation(() => UsersModelGQL)
    async editUser(@Args('payload') payload: UserInput, @Args('_id', { type: () => String }) _id: Schema.Types.ObjectId) {//@Args('_id', { type: () => String }) _id: Schema.Types.ObjectId
    ...
    @Roles('Management', 'Project Manager')
    @Mutation(() => Boolean)
    async fileUpload(@Args({ name: 'file', type: () => GraphQLUpload }) {
        createReadStream,
        filename
